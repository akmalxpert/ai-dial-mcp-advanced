...
class CustomMCPClient:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            init_response = await self._send_request("initialize", params=init_params)
            await self._send_notification("notifications/initialized")
            print(f"Connected to MCP server. Capabilities: {init_response.get('result', {}).get('capabilities', {})}")
